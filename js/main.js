...
function sectionTeamCarousselPrg() {
  $("#we-lead .wrapper-img .container-action .btn .progress").removeClass(
    "active"
  );
  setTimeout(function () {
    $("#we-lead .wrapper-img .container-action .btn .progress").addClass(
      "active"
    );
  }, 50);
  ...
  if (countEl < numberEl) {
    ...
    $(
      "#we-lead .wrapper-img .container-el .el:nth-child(" + countEl + ")"
    ).show();
...
$(document).ready(function () {
  $("#achievement-slider").owlCarousel({
    ...
    nav: true,
    navText: [
      '<span><svg width="13px" height="10px" viewBox="0 0 13 10"><path d="M1,5 L11,5"></path><polyline points="8 1 12 5 8 9"></polyline></svg></span>',
      '<span><svg width="13px" height="10px" viewBox="0 0 13 10"><path d="M1,5 L11,5"></path><polyline points="8 1 12 5 8 9"></polyline></svg></span>',
    ],
  });
});
